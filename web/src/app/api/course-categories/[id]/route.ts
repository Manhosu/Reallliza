 ...
 * Atualiza nome/descrição/ícone/ordem/ativo. Apenas admin.
 */
 ...
 * Soft-delete: marca is_active=false. Cursos da categoria continuam,
...
export async function DELETE(
  ...
  try {
    ...
    logAudit({
      userId: user.id,
      action: "course_category.deactivated",
      entityType: "course_category",
      entityId: id,
    });
